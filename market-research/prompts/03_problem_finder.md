...
## Search Strategy
Use `search_web` as the primary search method. If you need to read the full content of a specific webpage, use the Jina AI Reader API (`r.jina.ai/[url]`) via `run_command` with curl. Find using advanced operators:
